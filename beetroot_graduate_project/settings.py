"""
Django settings for beetroot_graduate_project project.
...
ROOT_URLCONF = 'beetroot_graduate_project.urls'
...
WSGI_APPLICATION = 'beetroot_graduate_project.wsgi.application'
